...
import Model.Bresenham_Bean;
import Controller.Bresenham_Action;
...
public class Bresenham_GUI extends javax.swing.JFrame {

    Bresenham_Bean bean = new Bresenham_Bean();   
    
    public Bresenham_GUI() {
        initComponents();    
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        this.setLocation(dim.width/2-this.getSize().width/2, dim.height/2-this.getSize().height/2);
        this.setTitle("Bresenham Calculator");
    ...
    public void mapOutput() {       
        ...
        Bresenham_Action A = new Bresenham_Action();
        A.Assign(bean.getStartX(), bean.getEndX(), bean.getStartY(), bean.getEndY());
        A.Calculate();       
        Map<String, ArrayList<Double>> map = new HashMap<>(A.Map());
        ArrayList<Double> xValues = map.get("xValues");
        ArrayList<Double> yValues = map.get("yValues");
        ArrayList<Double> pValues = map.get("pValues");
        Object[][] data = new String[xValues.size()][4];
        String[] columnNames = {"n", "X", "Y", "P"};
            ...
            for (int j = 0; j < 4; j++) {
                switch (j) {
                    ...
                    case 2:
                        ...
                        break;
                    default:
                        data[i][j] = pValues.get(i).toString();                        
                        break;
                }
            }
        }
    ...
    private void plotButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plotButtonActionPerformed
        Bresenham_PlotW d = new Bresenham_PlotW();
        d.Plot();
    }//GEN-LAST:event_plotButtonActionPerformed

    private void aboutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_aboutActionPerformed
        Bresenham_About A = new Bresenham_About();
        A.About();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bresenham_GUI().setVisible(true);
            }
        });
    }
